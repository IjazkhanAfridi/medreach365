...
const SchoolHome = () => {
  ...
  const initialData =
    students ||
    (students?.length >= 0 && Object?.values(students[0]?.medicalRecords));
        ...
        <div className='w-[100px] h-full min-h-[370px] flex flex-col bg-blue-900 rounded-lg items-center justify-around mx-5'>
          <div className='cursor-pointer' onClick={() => handleButtonClick('video')}>
            <svg
              ...
              height={'50px'}
            >
              <path fill='white' d='M0 128C0 92.7 28.7 64 64 64H320c35.3 0 64 28.7 64 64V384c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V128zM559.1 99.8c10.4 5.6 16.9 16.4 16.9 28.2V384c0 11.8-6.5 22.6-16.9 28.2s-23 5-32.9-1.6l-96-64L416 337.1V320 192 174.9l14.2-9.5 96-64c9.8-6.5 22.4-7.2 32.9-1.6z' />
            </svg>
          </div>
          ...
          <div className='cursor-pointer' onClick={() => setActiveComponent(null)}>
            <svg
              ...
              height={'50px'}
            >
              <path fill='white' d='M64 0C28.7 0 0 28.7 0 64V352c0 35.3 28.7 64 64 64h96v80c0 6.1 3.4 11.6 8.8 14.3s11.9 2.1 16.8-1.5L309.3 416H448c35.3 0 64-28.7 64-64V64c0-35.3-28.7-64-64-64H64z' />
            </svg>
          </div>
        </div>
