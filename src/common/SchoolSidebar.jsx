            ...
            <div className={`${showSidebar ? 'block' : 'hidden'} md:block bg-primary w-full md:w-[290px] text-white font-medium h-[100vh] `}>
                ...
                <div className="overflow-y-auto scrollbar h-[calc(100vh-100px)]">
                    <div className={`mx-auto `}>
                        ...
                        <div className="fixed bottom-0 pb-4  bg-primary w-[290px]">
                            <button onClick={() => navigate("/addstudent")} className=' w-[150px] border ml-[50px] border-white px-4 py-2 rounded-[22px] bg-primary'>
                                Add Student
                            </button>
                        </div>
                    </div>
